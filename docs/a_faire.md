...
7. [ ] ajout sélection multiples éléments (avec clic souris gauche enfoncé - carré sélection). Gérer le comportement avec une sélection multiple. (supprimer le focus sur le champ name par exemple).
